...
class PermissionForMenuDailyActivity extends Seeder
{
    /**
    ...
    {   
        ...
        $methods = ['index','create', 'show', 'edit', 'update', 'destroy', 'store', 'select2', 'storesubtask', 'comment', 'extend', 'updatemedia', 'report', 'deletemedia', 'approvement'];
