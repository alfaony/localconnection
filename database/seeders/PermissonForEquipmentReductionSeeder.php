...
class PermissonForEquipmentReductionSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $equipment = ['index','create', 'show', 'edit', 'update', 'destroy', 'store', 'select2'];
        ...
        foreach ($equipment as $method) 
        {
            ...
            $permission = Permission::firstOrCreate([
                'name' => ucwords($method).' Equipment Reduction',
            ],[
                'method' => $method,
                'table' => 'equipment_reductions',
                'model' => 'EquipmentReduction',
                'guard_name' => 'web'
            ]);
