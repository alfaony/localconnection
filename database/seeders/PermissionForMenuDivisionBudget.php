...
class PermissionForMenuDivisionBudget extends Seeder
{
    /**
    ...
    {   
        ...
        $methods = ['index','create', 'show', 'edit', 'update', 'destroy', 'store', 'select2', 'approve'];
        ...
        foreach ($methods as $method) 
        {
            ...
            $permission = Permission::firstOrCreate([
                'name' => ucwords($method).' Division Budget',
            ],[
                'method' => $method,
                'table' => 'division_budgets',
