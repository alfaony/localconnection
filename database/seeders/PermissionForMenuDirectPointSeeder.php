...
class PermissionForMenuDirectPointSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $methods = ['index','edit', 'create', 'update', 'show', 'destroy', 'store','approve','reject','checkQuota'];

        foreach ($methods as $method) 
        {
            // create permision
            $permission = Permission::firstOrCreate([
                'name' => ucwords($method).' Direct Point',
            ],[
                'method' => $method,
                'table' => 'direct_points',
                'model' => 'DirectPoint',
