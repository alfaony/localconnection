...
<head>
    ...
    <title>Penolakan Anggaran</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="title">Yth. {{ $data['user_create'] }},</p>
            <p>Pengajuan anggaran berikut telah ditolak:</p>
            ...
            <p><span class="title">Catatan:</span> {{ $data['note'] }}</p>
            <p>Terima kasih.</p>
            <p>Hormat kami,<br>{{ $data['approver_name'] }}</p>
        </div>
        <div class="footer">
