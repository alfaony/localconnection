...
<body>
    <div class="container">
        <div class="header">
            Kepada Yth. {{ $data['user_create'] }},
        </div>
        <div class="content">
            Terima kasih telah mengunggah laporan proyek untuk ditinjau. Setelah melakukan evaluasi, kami menemukan beberapa poin yang perlu diperbaiki atau dilengkapi sebelum laporan ini dapat disetujui. Mohon tinjau dan lakukan revisi pada laporan berikut:
        </div>
