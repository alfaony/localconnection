...
$no = ($suplier->currentPage() - 1) * $suplier->perPage() + 1;
$totalSuplier = $totalSuplier + 1; // Get the total number of projects
...
<div class="col-md-12">
    ...
    <div class="alert alert-success mt-3">Berhasil Menambahkan Suplier</div>
    @endif
    @if(Session::get('update'))
    <div class="alert alert-success mt-3">Suplier Berhasil Diperbarui</div>
    @endif
    @if(Session::get('delete'))
    <div class="alert alert-success mt-3">Berhasil Menghapus Suplier</div>
    @endif
    @if ($errors->any())
...
<div class="container">    
    ...
    {{ $suplier->withQueryString()->links('vendor.pagination.bootstrap-4') }}
...
<script>
    $(document).ready(function () {
        ...
        { 
            e.preventDefault();
            let no = "{{ $totalSuplier }}";
            let url = "{{ route('suplier.create') }}" + "?nomor="+no;
