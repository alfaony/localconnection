        ...
        <div class="col-md-8">
            <div class="card card-success">
                <div class="card-body text-center py-5">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('customer.subscriptions.show', $subscription) }}" class="btn btn-success btn-lg mr-2">
                            <i class="fas fa-eye"></i> Lihat Detail Subscription
                        </a>
                        <a href="{{ route('customer.subscriptions.index') }}" class="btn btn-outline-success btn-lg">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('customer.subscriptions.index') }}" class="btn btn-success btn-lg">
                            <i class="fas fa-list"></i> My Subscriptions
                        </a>
                    </div>
                    @endif
