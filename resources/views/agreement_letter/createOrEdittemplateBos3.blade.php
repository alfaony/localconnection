        ...
        <div class="card-body">
            ...
            @endif
                ...
                <div class="form-group row mt-5">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="commission_name" value="{{ old('commission_name') ?? @$agreementLetter->commission_name }}" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="" name="commission_phone" placeholder="0856...." value="{{ old('commission_phone') ?? @$agreementLetter->commission_phone }}">
                    </div>
                </div>
