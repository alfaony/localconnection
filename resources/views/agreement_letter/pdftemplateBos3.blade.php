        ...
        <div class="card-body" id="printItem">
            <div class="row">
                ...
                <img src="{{ asset('logo/officepllus.jpg') }}" alt="Signature" style="width:250px; height:auto" class="centered-image">
                    ...
                    <ul>
                        <li>
                            Bahwa PIHAK PERTAMA adalah perusahaan penyedia ruang kantor maya / virtual, ruang seminar, ruang pelatihan, layanan kantor virtual lainnya 
                        </li>
                        <li>
                            Bahwa PIHAK KEDUA adalah individu atau perusahaan yang dalam hal ini PIHAK KEDUA bermaksud untuk menyewa atau menggunakan layanan dari PIHAK PERTAMA 
                        </li>
                        <li>
                            Bahwa PENJAMIN adalah individu atau perusahan yang menjamin PIHAK KEDUA apabila PIHAK KEDUA tidak dapat dihubungi
                        </li>
                    </ul>
            ...
            <div class="row"> 
                <div class="col-12">
                    ...
                    <ol>
                        ...
                        <li>
                            PIHAK KEDUA dilarang mendaftarkan alamat kantor dengan tujuan pengajuan kredit pinjaman ataupun kartu kredit.
                        </li>
                        <li>
                            Dalam hal salah satu PIHAK lalai dalam menjalankan kewajiban yang telah diaturkan dalam perjanjian ini dan menimbulkan kerugian material pada pihak lainnya. Maka pihak yang lalai tersebut wajib bertanggung jawab atas kerugian material yang diderita oleh PIHAK lainnya.
                        </li>
                        <li>
                            PIHAK KEDUA menunjuk PENJAMIN sebagai pihak lain yang turut bertanggung jawab atas tindakan yang dilakukan PIHAK KEDUA. 
                        </li>
                        <li>
                            PIHAK KEDUA dan PENJAMIN membebaskan segala tuntutan hukum dan akibat hukum pada PIHAK PERTAMA. 
                        </li>
                    </ol>
