                        ...
                        <tbody>
                            @foreach ($userApps as $browser)
                                <tr>
                                    ...
                                    <td>{{ $browser->last_login_at ? \Carbon\Carbon::parse($browser->last_login_at)->format('d-m-Y H:i:s') : '-' }}</td>
                                    <td>{{ $browser->last_scheduled_checkin ? \Carbon\Carbon::parse($browser->last_scheduled_checkin)->format('d-m-Y H:i:s') : '-' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
