...
<div class="row mb-4">
    <div class="col-6 col-lg-3 mb-3">
        <div class="asset-stat-card" style="border-left: 4px solid #2563eb;">
            <div class="d-flex align-items-center gap-3">
                <div class="asset-stat-icon" style="background:#e0f0ff;color:#2563eb">
    ...
    <div class="col-6 col-lg-3 mb-3">
        <div class="asset-stat-card" style="border-left: 4px solid #16a34a;">
            <div class="d-flex align-items-center gap-3">
                <div class="asset-stat-icon" style="background:#e6f9f0;color:#16a34a">
    ...
    <div class="col-6 col-lg-3 mb-3">
        <div class="asset-stat-card" style="border-left: 4px solid #dc2626;">
            <div class="d-flex align-items-center gap-3">
                <div class="asset-stat-icon" style="background:#fde8e8;color:#dc2626">
    ...
    <div class="col-6 col-lg-3 mb-3">
        <div class="asset-stat-card" style="border-left: 4px solid #0891b2;">
            <div class="d-flex align-items-center gap-3">
                <div class="asset-stat-icon" style="background:#e0fafa;color:#0891b2">
...
<div class="card">
    <div class="table-responsive">
        <table class="table dash-table mb-0">
            <thead>
                <tr>
                    <th wire:click="sortBy('name')" class="cursor-pointer" style="cursor:pointer">
                        Nama Asset
                    ...
                    <th wire:click="sortBy('quantity')" style="cursor:pointer">
                        Qty
                        @if($sortField === 'quantity') <i class="fas fa-sort-{{ $sortDir === 'asc' ? 'up' : 'down' }} ml-1"></i> @endif
                    </th>
                    <th wire:click="sortBy('unit_price')" style="cursor:pointer">
                        Harga Satuan
                        @if($sortField === 'unit_price') <i class="fas fa-sort-{{ $sortDir === 'asc' ? 'up' : 'down' }} ml-1"></i> @endif
                    </th>
                    <th>Total Harga</th>
                    <th wire:click="sortBy('purchase_date')" style="cursor:pointer">
                        Tgl Beli
                        @if($sortField === 'purchase_date') <i class="fas fa-sort-{{ $sortDir === 'asc' ? 'up' : 'down' }} ml-1"></i> @endif
                    </th>
                    <th>Status</th>
                    <th>Tgl Rusak</th>
            ...
            @forelse($assets as $asset)
                <tr>
                    ...
                    <td>
                        <span class="category-chip">{{ $asset->category_label }}</span>
                    </td>
                    <td>
                        {{ $asset->brand ?? '–' }}
                    ...
                    <td class="text-center" style="white-space:nowrap">
                        ...
                        <button wire:click="toggleStatus('{{ $asset->id }}')"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content" style="border-radius:14px;border:none">
            <div class="modal-body text-center p-4">
                <div style="width:56px;height:56px;background:#fde8e8;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 16px;font-size:1.4rem;color:#dc2626">
                    <i class="fas fa-trash"></i>
                </div>
                <h5 class="font-weight-bold mb-2">Hapus Asset?</h5>
                <p class="text-muted" style="font-size:.85rem">Data akan dipindahkan ke trash dan bisa dipulihkan.</p>
                <div class="d-flex gap-2 justify-content-center mt-3">
                    <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Batal</button>
                    <button wire:click="destroy" type="button" class="btn btn-danger" data-dismiss="modal">
                        Ya, Hapus
                    </button>
                </div>
            </div>
...
@section('js')
<script>
window.addEventListener('show-delete-modal', () => $('#deleteModal').modal('show'));
window.addEventListener('hide-delete-modal', () => $('#deleteModal').modal('hide'));
</script>
@stop
