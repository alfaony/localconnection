...
<div class="card p-3">
    <div class="card-body col-md-12">
        ...
        <div class="alert alert-success mt-3">Import Berhasil</div>
        @endif
    ...
    <div class="card-body col-md-12">
        ...
        <a href="{{ route('dailytask.create') }}" class="btn btn-primary col-md-2"><i class="fa fa-plus"></i><span> Tugas</span></a>
        @endcanAccess
        @canAccess('template','dailytasks') 
        <a href="{{ route('dailytask.template') }}" class="btn btn-info col-md-2"><i class="fa fa-plus"></i><span> Import</span></a>
        @endcanAccess
    </div>
    <div class="card-body">
