...
<div class="card">
    <div class="card-body">
        <form action="{{ isset($kye) ? route('kye.update', $kye->id) : route('kye.store') }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            @if(isset($kye)) @method('PUT') @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center mt-2">
                            <button type="button" class="btn btn-outline-primary btn-sm me-2"
                                onclick="openCamera('employee_photo', 'employee_photo_preview')">
                                <i class="fas fa-camera"></i> Ambil Foto
                            </button>
                            <div id="employee_photo_preview" class="ms-2">
                                @if(isset($kye->employee_photo))
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center mt-2">
                            <button type="button" class="btn btn-outline-primary btn-sm me-2"
                                onclick="openCamera('ktp_photo', 'ktp_photo_preview')">
                                <i class="fas fa-camera"></i> Ambil Foto
                            </button>
                            <div id="ktp_photo_preview" class="ms-2">
                                @if(isset($kye->ktp_photo))
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center mt-2">
                            <button type="button" class="btn btn-outline-primary btn-sm me-3"
                                onclick="openCamera('selfie_ktp', 'selfie_ktp_preview')">
                                <i class="fas fa-camera"></i> Ambil Selfie
                            </button>
                            <div id="selfie_ktp_preview">
                                @if(isset($kye->selfie_ktp))
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center mt-2">
                            <button type="button" class="btn btn-outline-primary btn-sm me-3"
                                onclick="openCamera('ktp_family', 'ktp_family_preview')">
                                <i class="fas fa-camera"></i> Ambil Foto
                            </button>
