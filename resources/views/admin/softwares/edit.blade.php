    ...
    <div class="card">
        <form action="{{ route('admin.softwares.update', $software) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="tipe_paket" 
                                   name="tipe_paket" 
                                   value="{{ old('tipe_paket', $software->tipe_paket) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4"
                                      placeholder="Deskripsi singkat tentang software ini...">{{ old('description', $software->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" 
                                       ...
                                       name="logo"
                                       accept="image/*">
                                <label class="custom-file-label" for="logo">Ubah logo...</label>
                                @error('logo')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" 
                                    ...
                                    name="status" 
                                    required>
                                <option value="active" {{ old('status', $software->status) == 'active' ? 'selected' : '' }}>Active</option>
                                <option value="inactive" {{ old('status', $software->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                            @error('status')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('admin.softwares.index') }}" class="btn btn-secondary">
