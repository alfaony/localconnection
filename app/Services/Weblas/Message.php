...
class Message
{
    ...
    {
        $url = $this->client->api().'send-message';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
        ])->get($url, [
            'token'   => $this->client->fullToken(),
            'phone'   => $phone,
            'message' => $message,
        ]);
    ...
    {
        $url = $this->client->api().'send-image';
        $data = [
            'phone' => $phone,
            'image' => $image,
            'caption' => $caption,
    ...
    {
        $url = $this->client->api().'send-audio';
        $data = [
            'phone' => $phone,
            'audio' => $audio_url,
            'spintax' => true
    ...
    {
        $url = $this->client->api().'send-video';
        $data = [
            'phone' => $phone,
            'video' => $video_url,
            'caption' => $caption,
    ...
    {
        $url = $this->client->api().'send-document';
        $data = [
            'phone' => $phone,
    ...
    {
        $url = $this->client->api()."resend-message?id=$id";
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->get($url);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-message';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-image';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-video';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-audio';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-document';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    public function footer_message($phone,$message,$footer,$header=null)
    {
        ...
        $url = $this->client->api().'v2/send-template';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-list';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-location';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    {
        $payload = [ 'data'=> $data];
        $url = $this->client->api().'v2/send-button';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->post($url,$payload);
    ...
    public function local_file($file,$phone,$caption=null)
    {
        ...
        $url = $this->client->api()."send-$type-from-local";
    ...
    {
        $url = $this->client->api()."cancel-message?id=$id";
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->get($url);
    ...
    {
        $url = $this->client->api().'cancel-all-message';
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->get($url);
    ...
    {
        $url = $this->client->api()."revoke-message?id=$id";
        $response = Http::withHeaders([
            'Content-Type' => 'application/json',
            'Authorization'=> $this->client->token()
        ])->get($url);
