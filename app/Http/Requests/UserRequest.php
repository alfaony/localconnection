    ...
    public function rules()
    {
        ...
        if(!$userId)
        {
            return [
                ...
                'is_checkin' => 'nullable|string|in:wfo,wfh,shift,wfo_shift',
                'manual_checkin' => 'nullable|boolean',
                'requires_photo' => 'nullable|boolean',
                'requires_location' => 'nullable|boolean',
                'start_time' => 'required_if:is_checkin,wfh|nullable|date_format:H:i',
                'end_time' => 'required_if:is_checkin,wfh|nullable|date_format:H:i|after:start_time',
                'rest_time' => 'required_if:is_checkin,wfh|nullable|date_format:H:i',
                'end_rest_time' => 'required_if:is_checkin,wfh|nullable|date_format:H:i|after:rest_time',
