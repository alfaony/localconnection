...
/**
 * Sheet 1: Ringkasan poin per user
 */
class ReportPointProductivitySummarySheet implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle
{
    protected $reports;
    protected $startDate;
    protected $endDate;
