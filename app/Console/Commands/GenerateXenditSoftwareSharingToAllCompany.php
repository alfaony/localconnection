...
class GenerateXenditSoftwareSharingToAllCompany extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:xendit-software-sharing-to-all-company';
    ...
    public function handle()
    {
        ...
        $menu = 'xendit_software_subscription';
        $fields = ['public_key_software_subscription' => '', 'secret_key_software_subscription' => '', 'webhook_token_software_subscription' => '','xendit_pay_with_ppn_software_software_subscription'=>'0'];
