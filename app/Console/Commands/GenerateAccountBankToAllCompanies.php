...
class GenerateAccountBankToAllCompanies extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:bank-account';
    ...
    public function handle()
    {
        ...
        $fields = ['atas_nama' => null,'rekening_number' => null, 'nama_bank' => null,'cabang_bank' => null];
