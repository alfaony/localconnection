...
class GenerateSettingXeroTokensToAllCompany extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:setting_xero_access_to_all_company';
    ...
    public function handle()
    {
        ...
        $menu = 'xero';
        $fields = ['client_id' => '', 'client_secret' => '', 'webhook_key' => ''];
