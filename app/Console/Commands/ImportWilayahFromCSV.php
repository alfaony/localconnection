...
class ImportWilayahFromCSV extends Command
{
    ...
    private function importProvinces($country, $province = null, $city = null, $district = null, $subdistrict = null)
    {
        ...
        foreach ($provinceData as $provinceRow) {
            if ($province) {
                if ($provinceRow['prov_name'] !== $province) continue;
            }
    ...
    private function importCities($province, $provinceId, $city = null, $district = null, $subdistrict = null)
    {
        ...
        foreach ($cityData as $cityRow) {
            if ($cityRow['prov_id'] === $provinceId) {
                if ($city) {
                    if ($cityRow['city_name'] !== $city) continue;
                }
