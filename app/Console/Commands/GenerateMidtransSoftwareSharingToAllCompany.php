...
class GenerateMidtransSoftwareSharingToAllCompany extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:midtrans-software-sharing-to-all-company';
    ...
    public function handle()
    {
        ...
        $menu = 'midtrans_software_sharing';
